...
<head>
	...
	<title> IIS - MUTASI FINISH GOOD  </title>
	...
	<script type="text/javascript">
		...
		Ext.onReady(function(){
			...
			//	***
				var itemperpage = 15;
				//	json store
					Ext.define('mts_fgood',{
					   extend:'Ext.data.Model',
					   fields:[ 'kodebarang', 'namabarang', 'sal_awal', 'masuk', 'keluar', 'sal_akhir', 'fgood_periode', 'action_user', 'last_update' ]
					});
					var datastore = Ext.create('Ext.data.JsonStore', {
						...
						proxy		: {
							type	: 'ajax',
							url		: 'json/json_tbl_mts_fgood.php',
							extraParams: {
								valstdate: '999999',
								valendate: '999999',
							},
								...
								buttons			: [
									{
										...
										handler : function (){
											...
											window.open('response/down_mts_fgood.php?valstdate='+stdate+'&valendate='+endate+'&valpartno='+partno+'');
										}
									}, {
										text	: 'Search',
										iconCls	: 'search',
								...
								buttons			: [
									{
										...
										tooltip	: 'Format CSV',
										handler : function (){
											window.open('response/form_mts_fgood.php');
										}
									}, {
										text		: 'Upload',
										iconCls		: 'upload',
										...
										handler		: function() {
											...
											Ext.Msg.confirm('Upload Data', 'Periode: <b>'+period+'</b> <br> Apakah Anda yakin ingin melakukan proses ini ?', function(btn){
												if (btn == 'yes'){
													if (form.isValid()) {
														form.submit({
															url				: 'response/upl_mts_fgood.php',
				...
				//	grid
					...
					Ext.create('Ext.grid.Panel', {
						...
						columns: [
							...
							{ header: 'FGOOD PERIODE', 		dataIndex: 'fgood_periode',	flex: 1, align: 'center' }
...
<section>
	<div class="wrapper_section">
		...
		<div style="float:left;"> MUTASI FINISH GOOD </div> <div style="float:right"> Welcome: <?=$img .' <b>'. $sesiis_username?> </b></div>
		<br><br>
