...
require_once('../extjs/con_iis.php');
	...
	$rs 		= $db->Execute("insert into finishgoods
									(
								...
								from vw_pros_fgood('". $st_periode ."','". $en_periode ."')");
	$rs->Close();
	...
	echo "{
		'success': true,
		'msg': 'Finish Good File has been successfully processed.'
	}";
