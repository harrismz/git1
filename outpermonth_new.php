										...
										buttons			: [
											{
												...
												iconCls	: 'search',
												handler	: function() {
													data_opp.proxy.setExtraParam('st_date', Ext.Date.format(Ext.getCmp('st_date').getValue(), 'Ymd'));
													data_opp.proxy.setExtraParam('en_date', Ext.Date.format(Ext.getCmp('en_date').getValue(), 'Ymd'));
													data_opp.proxy.setExtraParam('dp_no', 	Ext.getCmp('dp_no').getValue() );
													data_opp.proxy.setExtraParam('partno', 	Ext.getCmp('partno').getValue() );
													data_opp.proxy.setExtraParam('files', 	Ext.getCmp('files').getValue() );
													data_opp.proxy.setExtraParam('jns_dok', Ext.getCmp('jns_dok').getValue() );
													data_opp.loadPage(1);
