...
<head>
	...
	<title> IIS - FINISH GOOD UPLOAD </title>
		...
		Ext.onReady(function(){
			...
			//	***
				//	json
					...
					Ext.define('fgood_temp', {
						extend	: 'Ext.data.Model',
						fields	: [ 'kodebarang', 'namabarang', 'sal_awal', 'masuk', 'keluar', 'sal_akhir', 'fgood_periode' ]
					});
					var ds_fgood_temp = Ext.create('Ext.data.Store', {
						model		: 'fgood_temp',
						autoLoad	: true,
			...
			//	***
				//	grid panel
					...
					var grd_mtr_temp = Ext.create('Ext.grid.Panel', {
						stateId		: 'grd_fgood_temp',
						renderTo	: 'grd_fgood_temp',
						title		: 'Data Finish Good Temp File',
						store		: ds_fgood_temp,
						width		: '100%',
						autoHeight	: true,
						x 			: 0, 
						...
						columns		: [
							...
							{ header: 'FINISH PERIODE', 	dataIndex: 'fgood_periode',	flex: 1, align: 'center' }
						],
						//	end columns
						listeners: {
							render: {
								...
								items			: [
									{
										...
										name				: 'ufile',
										fieldLabel			: 'Upload GCS File (*.txt)',
										buttonText			: '',
										allowBlank			: false,
										...
										id					: 'fgood_periode',
										name				: 'fgood_periode',
										fieldLabel			: 'Finish Good Periode (YYYYMM)',
										afterLabelTextTpl	: required
									},
								/*	
									{
								...
								buttons			: [
									{
										...
										handler		: function() {
											...
											if (form.isValid()) {
												form.submit({
													url		: 'response/resp_upld_fgood.php',
							...
							var grd_vw_transact = Ext.create('Ext.grid.Panel', {
								...
								tbar		: [
									...
									'->',
									{
										...
										tooltip	: 'Refresh',
										handler : function (){
											ds_trx_fgood.proxy.setExtraParam('st_periode', '' );
											ds_trx_fgood.proxy.setExtraParam('en_periode', '' );
											ds_trx_fgood.proxy.setExtraParam('kodebarang', '' );
											ds_trx_fgood.loadPage(1);
										}
									}, {
										xtype	: 'button',
										id		: 'btn_filter',
								...
								buttons			: [
									{
										...
										iconCls	: 'search',
										handler	: function() {
											ds_trx_fgood.proxy.setExtraParam('st_periode', Ext.Date.format(Ext.getCmp('st_periode').getValue(), 'Ym') );
											ds_trx_fgood.proxy.setExtraParam('en_periode', Ext.Date.format(Ext.getCmp('en_periode').getValue(), 'Ym') );
											ds_trx_fgood.proxy.setExtraParam('kodebarang', Ext.getCmp('kodebarang').getValue() );
											ds_trx_fgood.loadPage(1);
					...
					function fnc_proses() {
						...
						if (!win_proses) {
								...
								buttons			: [
									{
										...
										handler		: function() {
											...
											if (form.isValid()) {
												form.submit({
													url		: 'response/resp_pros_fgood.php',
													waitMsg	: 'sending data',
													...
													failure	: function(form, action) {
														Ext.Msg.show({
															title		:'Failure - Process Finish Good File',
															icon		: Ext.Msg.ERROR,
															msg			: action.result.msg,
															buttons		: Ext.Msg.OK
														});
							...
							win_proses = Ext.widget('window', {
								title			: 'Process Finish Good File',
								width			: 450,
								minWidth		: 450,
								height			: 140,
								minHeight		: 140,
...
<section>
	<div class="wrapper_section">
		...
		<div style="float:left;"> DATA UPLOAD FINISH GOOD TEMPORARY </div> <div style="float:right"> Welcome: <?=$img .' <b>'. $sesiis_username?> </b></div>
		<br><br><br><br>
		
		<div id="grd_fgood_temp"></div>
	</div>
</section>
