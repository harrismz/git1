		...
		Ext.onReady(function(){
			...
			//	***
				//	json finishgoods
					...
					var ds_finishgoods = Ext.create('Ext.data.Store', {
						model		: 'finishgoods',
						autoLoad	: true,
			...
			//	***
				//	grid panel
					...
					var grd_finishgoods = Ext.create('Ext.grid.Panel', {
						stateId		: 'grd_finishgoods',
						renderTo	: 'grd_finishgoods',
						title		: 'Data FINISH GOODS',
						store		: ds_finishgoods,
						width		: '100%',
						autoHeight	: true,
						//height		: 500,
						x 			: 0, 
						...
						columns		: [
							...
							{ header: 'KET',				dataIndex: 'ket',			flex: 1 }
						],
						//	end columns
						listeners: {
							render: {
						...
						tbar		: [
							{
								...
								tooltip	: 'Refresh',
								handler : function (){
									ds_finishgoods.proxy.setExtraParam('periode', '' );
									ds_finishgoods.proxy.setExtraParam('idfield', '' );
									ds_finishgoods.proxy.setExtraParam('srcfield', '' );
									Ext.getCmp('lbl_search').setText('');
									ds_finishgoods.loadPage(1);
								}
							}, {
								xtype	: 'button',
								id		: 'btn_filter',
								...
								buttons			: [
									{
										...
										handler	: function() {
											...
											ds_finishgoods.proxy.setExtraParam('periode', val_periode );
											ds_finishgoods.loadPage(1);
								...
								buttons			: [
									{
										...
										tooltip	: 'Format CSV',
										handler : function (){
											window.open('response/form_4bln_fgood.php');
										}
									}, {
										text		: 'Upload',
										iconCls		: 'upload',
										...
										handler		: function() {
											...
											Ext.Msg.confirm('Upload Data', 'Periode: <b>'+period+'</b> <br> Apakah Anda yakin ingin melakukan proses ini ?', function(btn){
												if (btn == 'yes'){
													if (form.isValid()) {
														form.submit({
															url				: 'response/upl_4bln_fgood.php',
...
<section>
	<div class="wrapper_section">
		...
		<div style="float:left;"> FINISH GOODS </div> <div style="float:right"> Welcome: <?=$img .' <b>'. $sesiis_username?> </b></div>
		<br><br><br><br>
		
		<div id="grd_finishgoods"></div>
	</div>
</section>
