...
?>
	...
	<head>
		...
		<title> IIS - MUTASI SERVICE PART </title> 
		...
		<script type="text/javascript">
			...
			Ext.onReady(function() {
				...
				var itemperpage = 15;
				//	json store
				Ext.define('mts_servicepart', {
					extend: 'Ext.data.Model',
					fields: ['kodebarang', 'namabarang', 'sal_awal', 'masuk', 'keluar', 'sal_akhir', 'mtr_periode', 'action_user', 'last_update']
				});
				var datastore = Ext.create('Ext.data.JsonStore', {
					model: 'mts_servicepart',
					autoLoad: true,
					pageSize: itemperpage,
					proxy: {
						type: 'ajax',
						url: 'json/json_tbl_mts_servicepart.php',
						extraParams: {
							valstdate: '999999',
							valendate: '999999',
						},
						...
						var frm_filter = Ext.widget('form', {
							...
							buttons: [{
								...
								handler: function() {
									...
									window.open('response/down_mts_servicepart.php?valstdate=' + stdate + '&valendate=' + endate + '&valpartno=' + partno + '');
								}
							}, {
								text: 'Search',
								iconCls: 'search',
					...
					if (!win_upload) {
						var frm_upload = Ext.widget('form', {
							...
							buttons: [{
								...
								tooltip: 'Format CSV',
								handler: function() {
									window.open('response/form_mts_servicepart.php');
								}
							}, {
								text: 'Upload',
								iconCls: 'upload',
								...
								handler: function() {
									...
									Ext.Msg.confirm('Upload Data', 'Periode: <b>' + period + '</b> <br> Apakah Anda yakin ingin melakukan proses ini ?', function(btn) {
										if (btn == 'yes') {
											if (form.isValid()) {
												form.submit({
													url: 'response/upl_mts_servicepart.php',
				...
				Ext.create('Ext.grid.Panel', {
					renderTo: 'panelgrid',
					title: 'Data Mutasi Service Parts',
					store: datastore,
					width: '100%',
					autoHeight: true,
					columnLines: true,
	...
	<body id="body">
		...
		<section>
			<div class="wrapper_section">
				...
				<div style="float:left;"> MUTASI SERVICE PARTS </div>
				<div style="float:right"> Welcome: <?= $img . ' <b>' . $sesiis_username ?> </b></div>
				<br><br>
