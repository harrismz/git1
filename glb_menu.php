<?php
	...
	echo "<ul id=\"nav\">";
	if( $userlevel == 'ADMIN' ){
		if($userid == 'admin' ||$userid == '31530'|| $userid == '37299' || $userid == '33109' ){
			...
			echo "<li><a href=\"userlog.php\"> LOG ACTIVITY </a></li>";
		}
		
		echo "<li><a href=\"#\"> LAPORAN MUTASI BULANAN </a>".
				"<ul>".
					"<li><a href=\"mts_scrap.php\"> SCRAP </a></li>".
					"<li><a href=\"mts_material.php\"> MATERIAL </a></li>".
					"<li><a href=\"mts_fgood.php\"> FINISH GOOD </a></li>".
					"<li><a href=\"mts_famachine.php\"> FIXED ASSET & MACHINE </a></li>".
					"<li><a href=\"mts_svcpart.php\"> SERVICE PARTS </a></li>".
				"</ul>".
			 "</li>";
		...
		echo "<li><a href=\"#\"> LAPORAN PERBULAN </a>".
				"<ul>".
					"<li><a href=\"inpermonth.php\"> PEMASUKAN </a></li>".
					"<li><a href=\"outpermonth.php\"> PENGELUARAN </a></li>".
	...
	elseif( $userlevel == 'USER' ){
		echo "<li><a href=\"userlogin.php\"> LOG ACTIVITY </a></li>";
		echo "<li><a href=\"#\"> LAPORAN MUTASI BULANAN </a>".
				"<ul>".
					"<li><a href=\"mts_scrap.php\"> SCRAP </a></li>".
					"<li><a href=\"mts_material.php\"> MATERIAL </a></li>".
