	...
	else
	{
				...
				//	end of json cbx month
					...
					var grid_ipp= Ext.create('Ext.grid.Panel', {
						...
						columns		: [
							...
							{ header: 'Jenis Dokumen',  	dataIndex: 'jnsdok', flex : 1},
							{
								header : 'Dokumen Pabean', width : 150,
								columns : [
												{ header : 'No', dataIndex : 'BCNO', flex : 1},
												{ header: 'Tanggal', dataIndex: 'period',	width: 100,	renderer: Ext.util.Format.dateRenderer('d-M-Y')}
											]
							},
							{
								header: 'Bukti Penerimaan Barang', width:120,
								columns: [	
										{ header: 'No.', dataIndex : 'tglBC', flex : 1},
										{ header: 'Tanggal', dataIndex: 'period',	width: 100,	renderer: Ext.util.Format.dateRenderer('d-M-Y')}
								]
							},
							{ header: 'Pemasok',  width : 125,		dataIndex: 'supp'},
							{ header: 'Partno',  	width : 150,	dataIndex: 'partno'},
							{ header: 'Partname',	width : 200,		dataIndex: 'partname'},
							{ header: 'Sat', 		dataIndex: 'sat', flex : 1},
							{ header: 'Jumlah', 		dataIndex: 'qty', flex : 1},
							{ header: 'Nilai', 		dataIndex: 'nilai', flex : 1},
							...
							buttons			: [
								{
									...
									handler	: function() {
										...
										data_opp.proxy.setExtraParam('periode', val_periode );
										data_opp.loadPage(1);
									}
								}
							]
		...
		<section>
			<div class="wrapper_section">
				...
				<div style="float:left;"><b>Outgoing Parts Permonth </b></div> <div style="float:right"> Welcome: <?=$img .' <b>'. $sesmis_username?> </b></div>
				<br><br><br><br>
