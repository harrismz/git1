			...
			if (is_uploaded_file($_FILES['ufile']['tmp_name'])) 
			{
				...
				while ($i = fgetcsv($feed, 1000, ",")) 
				{
					if(trim($i['0']) != "Jenis Dokumen"){
						...
						$rs = $db->Execute("insert 	into tbl_inpart(jns_dok, dp_no, dp_tgl, bpb_no, bpb_tgl, pemasok, partno, partname, sat, jumlah, nilai, periode, files, currency)
