		...
		<script type="text/javascript">
			...
			Ext.onReady(function() {
				...
				var datastore = Ext.create('Ext.data.JsonStore', {
					...
					proxy: {
						type: 'ajax',
						url: 'json/json_tbl_mts_scrap.php',
						extraParams: {
							valstdate: '999999',
							valendate: '999999',
						},
						...
						var frm_filter = Ext.widget('form', {
							...
							buttons: [{
								...
								handler: function() {
									...
									window.open('response/down_mts_scrap.php?valstdate=' + stdate + '&valendate=' + endate + '&valpartno=' + partno + '');
								}
							}, {
								text: 'Search',
								iconCls: 'search',
					...
					if (!win_upload) {
						var frm_upload = Ext.widget('form', {
							...
							buttons: [{
								...
								tooltip: 'Format CSV',
								handler: function() {
									window.open('response/form_mts_scrap.php');
								}
							}, {
								text: 'Upload',
								iconCls: 'upload',
								...
								handler: function() {
									...
									Ext.Msg.confirm('Upload Data', 'Periode: <b>' + period + '</b> <br> Apakah Anda yakin ingin melakukan proses ini ?', function(btn) {
										if (btn == 'yes') {
											if (form.isValid()) {
												form.submit({
													url: 'response/upl_mts_scrap.php',
				...
				Ext.create('Ext.grid.Panel', {
					...
					columns: [{
						...
						{
							header: 'SCRAP PERIODE',
							dataIndex: 'scrap_periode',
							flex: 1,
							align: 'center'
						}
	...
	<body id="body">
		...
		<section>
			<div class="wrapper_section">
				...
				<div style="float:left;"> MUTASI SCRAP </div>
