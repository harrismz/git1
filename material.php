		...
		Ext.onReady(function(){
			...
			//	***
				//	json material
					...
					var ds_material = Ext.create('Ext.data.Store', {
						model		: 'material',
						autoLoad	: true,
			...
			//	***
				//	grid panel
					...
					var grd_material = Ext.create('Ext.grid.Panel', {
						stateId		: 'grd_material',
						renderTo	: 'grd_material',
						title		: 'Data Material',
						store		: ds_material,
						width		: '100%',
						autoHeight	: true,
						...
						tbar		: [
							{
								...
								tooltip	: 'Refresh',
								handler : function (){
									ds_material.proxy.setExtraParam('periode', '' );
									ds_material.proxy.setExtraParam('idfield', '' );
									ds_material.proxy.setExtraParam('srcfield', '' );
									Ext.getCmp('lbl_search').setText('');
									ds_material.loadPage(1);
								}
							}, {
								xtype	: 'button',
								id		: 'btn_filter',
								...
								buttons			: [
									{
										...
										handler	: function() {
											...
											ds_material.proxy.setExtraParam('periode', val_periode );
											ds_material.loadPage(1);
								...
								buttons			: [
									{
										...
										tooltip	: 'Format CSV',
										handler : function (){
											window.open('response/form_4bln_material.php');
										}
									}, {
										text		: 'Upload',
										iconCls		: 'upload',
										...
										handler		: function() {
											...
											Ext.Msg.confirm('Upload Data', 'Periode: <b>'+period+'</b> <br> Apakah Anda yakin ingin melakukan proses ini ?', function(btn){
												if (btn == 'yes'){
													if (form.isValid()) {
														form.submit({
															url				: 'response/upl_4bln_material.php',
...
<section>
	<div class="wrapper_section">
		...
		<div style="float:left;"> MATERIAL </div> <div style="float:right"> Welcome: <?=$img .' <b>'. $sesiis_username?> </b></div>
		<br><br><br><br>
		
		<div id="grd_material"></div>
	</div>
</section>
