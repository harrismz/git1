...
<head>
	...
	<title> IIS - FIXED ASSET & MACHINE  </title>
		...
		Ext.onReady(function(){
			...
			//	***
				//	json famachine
					...
					var ds_famachine = Ext.create('Ext.data.Store', {
						model		: 'famachine',
						autoLoad	: true,
			...
			//	***
				//	grid panel
					...
					var grd_famachine = Ext.create('Ext.grid.Panel', {
						stateId		: 'grd_famachine',
						renderTo	: 'grd_famachine',
						title		: 'Data Fixed Asset & Machine',
						store		: ds_famachine,
						width		: '100%',
						autoHeight	: true,
						x 			: 0, 
						...
						columns		: [
							...
							{ header: 'Ket',				dataIndex: 'ket',			width: 162 }
						],
						//	end columns
						listeners: {
							render: {
						...
						tbar		: [
							{
								...
								tooltip	: 'Refresh',
								handler : function (){
									ds_famachine.proxy.setExtraParam('periode', '' );
									ds_famachine.proxy.setExtraParam('idfield', '' );
									ds_famachine.proxy.setExtraParam('srcfield', '' );
									Ext.getCmp('lbl_search').setText('');
									ds_famachine.loadPage(1);
								}
							}, {
								xtype	: 'button',
								id		: 'btn_filter',
								...
								buttons			: [
									{
										...
										handler	: function() {
											...
											ds_famachine.proxy.setExtraParam('periode', val_periode );
											ds_famachine.loadPage(1);
								...
								buttons			: [
									{
										...
										tooltip	: 'Format CSV',
										handler : function (){
											window.open('response/form_4bln_famachine.php');
										}
									}, {
										text		: 'Upload',
										iconCls		: 'upload',
										...
										handler		: function() {
											...
											Ext.Msg.confirm('Upload Data', 'Periode: <b>'+period+'</b> <br> Apakah Anda yakin ingin melakukan proses ini ?', function(btn){
												if (btn == 'yes'){
													if (form.isValid()) {
														form.submit({
															url				: 'response/upl_4bln_famachine.php',
...
<section>
	<div class="wrapper_section">
		...
		<div style="float:left;"> FIXED ASSET & MACHINE </div> <div style="float:right"> Welcome: <?=$img .' <b>'. $sesiis_username?> </b></div>
		<br><br><br><br>
		
		<div id="grd_famachine"></div>
	</div>
</section>
