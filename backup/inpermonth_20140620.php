					...
					//	***					
						//json
							...
							Ext.define('inpart', {
								...
								fields : ['jns_dok', 'dp_no', 'dp_tgl', 'bpb_no', 'bpb_tgl', 'pemasok', 'partno', 'partname', 'sat', 'jumlah', 'nilai', 'periode']
							});
						...
						//	grid panel
							...
							var grid_ipp = Ext.create('Ext.grid.Panel', {
								...
								columns		: [
									...
									{ header: 'JUMLAH', 	dataIndex: 'jumlah', 	flex : 1, align: 'right', renderer: numeric, summaryType: 'sum', summaryRenderer: Ext.util.Format.numberRenderer('0,000,000') },
