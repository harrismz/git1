			...
			Ext.Loader.setPath('Ext.ux', './extjs/examples/ux/');
				...
				//json for grid finish goods
					...
					Ext.define('inpart', {
						...
						fields : ['jns_dok', 'dp_no', 'dp_tgl', 'bpb_no', 'bpb_tgl', 'pemasok', 'partno', 'partname', 'sat', 'jumlah', 'nilai']
					});
				...
				//	end of json cbx month
					...
					var grid_ipp= Ext.create('Ext.grid.Panel', {
						...
						columns		: [
							...
							{ header: 'Jenis Dokumen',  	dataIndex: 'jns_dok', 	width: 80 },
							{
								header: 'Dokumen Pabean', width : 150,
								columns : [
									{ header: 'No', 		dataIndex: 'dp_no', 	width: 120 },
									{ header: 'Tanggal', 	dataIndex: 'dp_tgl',	width: 80,	renderer: Ext.util.Format.dateRenderer('d-M-Y')}
								]
							},
							{
								header: 'Bukti Penerimaan Barang', width:120,
								columns: [	
									{ header: 'No.', 		dataIndex: 'bpb_no', 	width: 120 },
									{ header: 'Tanggal', 	dataIndex: 'bpb_tgl',	width: 80,	renderer: Ext.util.Format.dateRenderer('d-M-Y')}
								]
							},
							{ header: 'Pemasok',  	dataIndex: 'pemasok', 	width : 125 },
							{ header: 'Partno',  	dataIndex: 'partno',	width : 150 },
							{ header: 'Partname',	dataIndex: 'partname', 	width : 200 },
							{ header: 'Sat', 		dataIndex: 'sat', 		flex : 1 },
							{ header: 'Jumlah', 	dataIndex: 'jumlah', 	flex : 1, align: 'right' },
							{ header: 'Nilai', 		dataIndex: 'nilai', 	flex : 1, align: 'right' }
						],
						//	end columns
						listeners: {
							render: {
