...
<head>
	...
	<title> IIS - MUTASI FIXED ASSET AND MACHINE  </title>
	...
	<script type="text/javascript">
		...
		Ext.onReady(function(){
			...
			//	***
				var itemperpage = 15;
				//	json store
					Ext.define('mts_famach',{
					   extend:'Ext.data.Model',
					   fields:[ 'kodebarang', 'namabarang', 'sal_awal', 'masuk', 'keluar', 'sal_akhir', 'famach_periode', 'action_user', 'last_update' ]
					});
					var datastore = Ext.create('Ext.data.JsonStore', {
						...
						proxy		: {
							type	: 'ajax',
							url		: 'json/json_tbl_mts_famachine.php',
							extraParams: {
								valstdate: '999999',
								valendate: '999999',
							},
			...
			//	***
								...
								buttons			: [
									{
										...
										handler : function (){
											...
											window.open('response/down_mts_famachine.php?valstdate='+stdate+'&valendate='+endate+'&valpartno='+partno+'');
										}
									}, {
										text	: 'Search',
										iconCls	: 'search',
								...
								buttons			: [
									{
										...
										tooltip	: 'Format CSV',
										handler : function (){
											window.open('response/form_mts_famachine.php');
										}
									}, {
										text		: 'Upload',
										iconCls		: 'upload',
										...
										handler		: function() {
											...
											Ext.Msg.confirm('Upload Data', 'Periode: <b>'+period+'</b> <br> Apakah Anda yakin ingin melakukan proses ini ?', function(btn){
												if (btn == 'yes'){
													if (form.isValid()) {
														form.submit({
															url				: 'response/upl_mts_famachine.php',
				...
				//	grid
					...
					Ext.create('Ext.grid.Panel', {
						renderTo	: 'panelgrid',
						title		: 'Data Mutasi Fixed Asset and Machine',
						store		: datastore,
						width		: '100%',
						autoHeight	: true,
						columnLines	: true,
						...
						columns: [
							...
							{ header: 'SALDO AWAL', 		dataIndex: 'sal_awal',		flex: 1, align: 'right', renderer : numeric },
							{ header: 'JML MASUK', 			dataIndex: 'masuk',			flex: 1, align: 'right', renderer : numeric },
							{ header: 'JML KELUAR', 		dataIndex: 'keluar',		flex: 1, align: 'right', renderer : numeric },
							{ header: 'SALDO AKHIR', 		dataIndex: 'sal_akhir',		flex: 1, align: 'right', renderer : numeric },
							{ header: 'FIXED ASSET<br>MACHINE PERIODE', 	dataIndex: 'famach_periode',flex: 1, align: 'center' }
...
<section>
	<div class="wrapper_section">
		...
		<div style="float:left;"> MUTASI FIXED ASSET AND MACHINE </div> <div style="float:right"> Welcome: <?=$img .' <b>'. $sesiis_username?> </b></div>
		<br><br>
