...
?>
	...
	<head>
		...
		<title> IIS - MUTASI MATERIAL </title>
		...
		<script type="text/javascript">
			...
			Ext.onReady(function() {
				...
				var datastore = Ext.create('Ext.data.JsonStore', {
					...
					proxy: {
						type: 'ajax',
						url: 'json/json_tbl_mts_material.php',
						extraParams: {
							valstdate: '999999',
							valendate: '999999',
						},
						...
						var frm_filter = Ext.widget('form', {
							...
							buttons: [{
								...
								handler: function() {
									...
									window.open('response/down_mts_material.php?valstdate=' + stdate + '&valendate=' + endate + '&valpartno=' + partno + '');
								}
							}, {
								text: 'Search',
								iconCls: 'search',
					...
					if (!win_upload) {
						var frm_upload = Ext.widget('form', {
							...
							buttons: [{
								...
								tooltip: 'Format CSV',
								handler: function() {
									window.open('response/form_mts_material.php');
								}
							}, {
								text: 'Upload',
								iconCls: 'upload',
								...
								handler: function() {
									...
									Ext.Msg.confirm('Upload Data', 'Periode: <b>' + period + '</b> <br> Apakah Anda yakin ingin melakukan proses ini ?', function(btn) {
										if (btn == 'yes') {
											if (form.isValid()) {
												form.submit({
													url: 'response/upl_mts_material.php',
	...
	<body id="body">
		...
		<section>
			<div class="wrapper_section">
				...
				<div style="float:left;"> MUTASI MATERIAL </div>
